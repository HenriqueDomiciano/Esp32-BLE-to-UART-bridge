...
static void ble_spp_server_advertise(void) {
  ...
  fields.flags = BLE_HS_ADV_F_DISC_GEN | BLE_HS_ADV_F_BREDR_UNSUP | BLE_HS;
...
#endif
#ifdef CONFIG_BLE_SECURITY_STATIC_KEY
...
esp_power_level_t
get_esp32_power_value_based_on_int(int8_t power_configuration) {
...
void configure_sm_static_key_init(void) {
